...
#   Find product of k amount of integer in a series of number
...
# Function max_product_series()
#   Find the maximum product in a series
...
for serie in series:
    print(serie, end="")
print("\nThe maximum product with {} numbers is: {:,}".format(
    k, max_product_series(series, k)))
